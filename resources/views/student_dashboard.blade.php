<x-app-layout>
    @if (session('notification'))
        <div class="bg-red-500 mb-3 text-white rounded-lg p-4 flex justify-between" role="alert">
            {{ session('notification') }}
            <a href="{{ route('student.profile.index') }}">Complete Profile</a>
        </div>
    @endif
    <!-- ===== Main Content Start ===== -->
    <div class="bg-indigo-600 px-8 pt-10 lg:pt-14 pb-16 flex justify-between items-center mb-3">
        <!-- title -->
        <h1 class="text-xl text-white">Project - students</h1>
        <a href="#"
                    ...
                    <table class="text-left w-full whitespace-nowrap">
                        ...
                        <tbody>
                            <tr>
                                <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                                    <div class="flex items-center">
                                        <img src="./assets/images/svg/brand-logo-1.svg" alt=""
                                            class="h-6 w-6" />
                            ...
                            <tr>
                                <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                                    <div class="flex items-center">
                                        <img src="./assets/images/svg/brand-logo-2.svg" alt=""
                                            class="h-6 w-6" />
                            ...
                            <tr>
                                <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                                    <div class="flex items-center">
                                        <img src="./assets/images/svg/brand-logo-3.svg" alt=""
                                            class="h-6 w-6" />
                            ...
                            <tr>
                                <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                                    <div class="flex items-center">
                                        <img src="./assets/images/svg/brand-logo-4.svg" alt=""
                                            class="h-6 w-6" />
                            ...
                            <tr>
                                <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                                    <div class="flex items-center">
                                        <img src="./assets/images/svg/brand-logo-5.svg" alt=""
                                            class="h-6 w-6" />
                            ...
                            <tr>
                                <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                                    <div class="flex items-center">
                                        <img src="./assets/images/svg/brand-logo-6.svg" alt=""
                                            class="h-6 w-6" />
                            ...
                            <tr>
                                <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                                    <div class="flex items-center">
                                        ...
                                        <label for="checkboxOne" class="text-base ml-2 text-slate-600">Design a
                                            FreshCart Home
                                            page</label>
                                    </div>
                                </td>
                            ...
                            <tr>
                                <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                                    <div class="flex items-center">
                                        ...
                                        <label for="checkboxThree" class="text-base ml-2 text-slate-600">Dash UI
                                            landing page
                                            design</label>
                                    </div>
                                </td>
                            ...
                            <tr>
                                <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                                    <div class="flex items-center">
                                        ...
                                        <label for="checkboxFour" class="text-base ml-2 text-slate-600">Next.js Dash
                                            UI
                                            version</label>
                                    </div>
                                </td>
                            ...
                            <tr>
                                <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                                    <div class="flex items-center">
                                        ...
                                        <label for="checkboxFive" class="text-base ml-2 text-slate-600">Develop a Dash
                                            UI
                                            Laravel</label>
                                    </div>
                                </td>
                            ...
                            <tr>
                                <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                                    <div class="flex items-center">
                                        ...
                                        <label for="checkboxSeven" class="text-base ml-2 text-slate-600">Develop a
                                            Dash UI
                                            Laravel</label>
                                    </div>
                                </td>
