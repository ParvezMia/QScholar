<x-app-layout>
    <div class="bg-indigo-600 px-8 pt-10 lg:pt-14 pb-16 flex justify-between items-center mb-3">
        <h1 class="text-xl text-white">Edit Student</h1>
    </div>
                ...
                <form action="{{ route('students.update', $students->id) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="grid lg:grid-cols-2 gap-6">
                        <div class="py-3">
                            ...
                            <input type="text" id="student_first_name" name="student_first_name"
                                ...
                                value="{{ old('student_first_name', $students->student_first_name) }}" />
                        ...
                        <div class="py-3">
                            ...
                            <input type="text" id="student_last_name" name="student_last_name"
                                ...
                                value="{{ old('student_last_name', $students->student_last_name) }}" />
                    ...
                    <div class="grid lg:grid-cols-2 gap-6">
                        <div class="py-3">
                            ...
                            <select id="student_education_level" name="student_education_level"
                                ...
                                <option value="highschool"
                                    {{ $students->student_education_level == 'highschool' ? 'selected' : '' }}>High
                                    School</option>
                                <option value="college"
                                    {{ $students->student_education_level == 'college' ? 'selected' : '' }}>College
                                </option>
                                <option value="university"
                                    {{ $students->student_education_level == 'university' ? 'selected' : '' }}>
                                    University
                                </option>
                            </select>
                        ...
                        <div class="py-3">
                            ...
                            <select id="student_last_degree" name="student_last_degree"
                                class="border border-gray-300 text-gray-900 rounded focus:ring-indigo-600 focus:border-indigo-600 block w-full p-2 px-3">
                                <option value="highschool"
                                    {{ $students->student_last_degree == 'highschool' ? 'selected' : '' }}>High School
                                </option>
                                <option value="college"
                                    {{ $students->student_last_degree == 'college' ? 'selected' : '' }}>College
                                </option>
                                <option value="university"
                                    {{ $students->student_last_degree == 'university' ? 'selected' : '' }}>University
                                </option>
                            </select>
                    ...
                    <div class="py-3">
                        ...
                        <input type="text" id="student_contact_number" name="student_contact_number"
                            ...
                            value="{{ old('student_contact_number', $students->student_contact_number) }}" />
                    ...
                    <div class="py-3">
                        ...
                        <textarea id="student_address" name="student_address"
                            class="border border-gray-300 text-gray-900 rounded focus:ring-indigo-600 focus:border-indigo-600 block w-full p-2 px-3"
                            placeholder="student_address">{{ old('student_address', $students->student_address) }}</textarea>
