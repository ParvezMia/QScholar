<x-app-layout>
    <div class="bg-indigo-600 px-8 pt-10 lg:pt-14 pb-16 flex justify-between items-center mb-3">
        <h1 class="text-xl text-white">Edit Scholarship</h1>
    </div>
    <div class="-mt-12 mx-6 mb-6 grid grid-cols-1 gap-x-6 gap-y-6 sm:grid-cols-1 xl:grid-cols-1">
        <div class="card shadow">
            <div class="card-body">
                <form id="scholarship-form" action="{{ route('scholarships.update', $scholarship->id) }}" method="post">
                    @csrf
                    @method('PUT')
                    <div class="py-3">
                        ...
                        <select id="scholarship_organization_id" name="scholarship_organization_id"
                            ...
                            @foreach ($organizations as $organization)
                                <option value="{{ $organization->id }}"
                                    {{ $organization->id == $scholarship->scholarship_organization_id ? 'selected' : '' }}>
                    ...
                    <div class="py-3">
                        ...
                        <div id="editor" name="scholarship_description">
                            {!! old('scholarship_description', $scholarship->scholarship_description) !!}
                        </div>
                        <textarea id="scholarship_description" name="scholarship_description" hidden>{{ old('scholarship_description', $scholarship->scholarship_description) }}</textarea>
                    ...
                    <div class="py-3">
                        ...
                        <input type="number" id="scholarship_amount" name="scholarship_amount"
                            class="border border-gray-300 text-gray-900 rounded focus:ring-indigo-600 focus:border-indigo-600 block w-full p-2 px-3"
                            placeholder="Amount"
                            value="{{ old('scholarship_amount', $scholarship->scholarship_amount) }}" />
                    ...
                    <div class="py-3">
                        ...
                        <input type="date" id="scholarship_application_deadline"
                            ...
                            class="border border-gray-300 text-gray-900 rounded focus:ring-indigo-600 focus:border-indigo-600 block w-full p-2 px-3"
                            value="{{ old('scholarship_application_deadline', \Carbon\Carbon::parse($scholarship->scholarship_application_deadline)->format('Y-m-d')) }}" />
                    ...
                    <div class="py-3">
                        ...
                        <textarea id="scholarship_eligibility_criteria" name="scholarship_eligibility_criteria"
                            class="border border-gray-300 text-gray-900 rounded focus:ring-indigo-600 focus:border-indigo-600 block w-full p-2 px-3"
                            placeholder="Eligibility Criteria">{{ old('scholarship_eligibility_criteria', $scholarship->scholarship_eligibility_criteria) }}</textarea>
